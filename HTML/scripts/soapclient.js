...
SOAPClient._loadWsdl = function(url, method, parameters, async, callback)
{
    ...
    if(async)xmlHttp.open("GET", url + "?jsonmodel", async);
...
SOAPClient._sendSoapRequest = function(url, method, parameters, async, callback, wsdl)
{
    ...
    if (SOAPClient.userName && SOAPClient.password){
        ...
        xmlHttp.setRequestHeader("Access-Control-Allow-Origin","http://winstarapp3.screwtopmedia.com");  
    ...
    //xmlHttp.setRequestHeader("Content-Type", "text/xml; charset=utf-8");
        ...
        xmlHttp.setRequestHeader("Access-Control-Allow-Origin","http://winstarapp3.screwtopmedia.com");  
        xmlHttp.setRequestHeader("Request-Method","GET");

        xmlHttp.setRequestHeader("Access-Control-Allow-Origin","http://winstarapp3.screwtopmedia.com");  
        xmlHttp.setRequestHeader("Access-Control-Allow-Methods","GET, PUT, POST, DELETE, OPTIONS");
        xmlHttp.setRequestHeader("Access-Control-Allow-Headers","Api-Key, Content-Type, Content-Range, Content-Disposition, Content-Description");
    if(async)
    {
        xmlHttp.onreadystatechange = function()
        {
